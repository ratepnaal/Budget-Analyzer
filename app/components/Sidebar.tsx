...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-14 sm:top-16 right-0 bottom-0 z-40 w-64 sm:w-72 border-l border-outline-variant bg-surface shadow-2xl transition-transform duration-300 ease-out lg:static lg:z-auto lg:w-72 lg:translate-x-0 lg:shadow-none lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] ${isOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'}`}
      >
